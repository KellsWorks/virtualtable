      ...
      <template #header>
        <!-- <BaseDropdown menu-on-right>
          <template #title-container>
            <BaseButton type="primary" size="md" outline class="pr-2 pl-3">
              <i class="fa fa-download"></i>
              <i class="fa fa-chevron-down m-0"></i>
            </BaseButton>
          </template>

          <a href="javascript:;" @click="showExport" :class="disableClass"
            >CSV - Kale export</a
          >
          <a href="javascript:;" @click="showExportQR" :class="disableClass"
            >CSV - QR export</a
          >
        </BaseDropdown> -->
      </template>
...
// const showExport = () => {
//   downloadString(vt.value.itemsAsCSV());
// };
// const showExportQR = () => {
